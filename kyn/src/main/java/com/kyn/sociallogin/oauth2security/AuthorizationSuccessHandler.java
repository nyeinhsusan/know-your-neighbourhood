package com.kyn.sociallogin.oauth2security;
...
import com.kyn.sociallogin.configuration.AppProperties;
...
public class AuthorizationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler{
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        Optional<String> redirectUri = CookieUtils.getCookie(request, com.kyn.sociallogin.oauth2security.HttpCookieAuthorizationRequestRepo.REDIRECT_URI_PARAM_COOKIE_NAME)
                .map(Cookie::getValue);
